...
| languageUserDefined<sup>[v1.5.0](https://github.com/imzbf/md-editor-v3/releases/tag/v1.5.0) changed</sup> | Object | {key: StaticTextDefaultValue} | √ | Expand language，update `language` api to your key |
...
| screenfull<sup><sup>v1.4.3</sup></sup> | Object | null | x | Screenfull instance, editor will not insert script of it |
| screenfullJs<sup><sup>v1.4.3</sup></sup> | String | [screenfull@5.1.0](https://cdn.jsdelivr.net/npm/screenfull@5.1.0/dist/screenfull.js) | x | Screenfull js url |
| previewTheme<sup><sup>v1.4.3</sup></sup> | 'default' \| 'github' \| 'vuepress' | 'default' | √ | Preview themes |
