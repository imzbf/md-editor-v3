> 当前最新版本：[v1.4.0](https://github.com/imzbf/md-editor-v3/releases/tag/v1.4.0)
...
<html lang="zh-CN">
  <head>
    ...
    <link href="https://cdn.jsdelivr.net/npm/md-editor-v3@1.4.0/lib/style.css" rel="stylesheet" />
  </head>
  <body>
    <div id="md-editor-v3">
    ...
    <script src="https://cdn.jsdelivr.net/npm/md-editor-v3@1.4.0/lib/md-editor-v3.umd.js"></script>
    <script>
      const App = {
        data() {
          return {
