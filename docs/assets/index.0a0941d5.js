...
- \u76EE\u5F55\u5BFC\u822A
  ...
  **\u5168\u5C40\u6CE8\u518C**
  ...
  <\/script>
  \`\`\`
`;const w={class:"container"},k={class:"doc"},D={class:"content",style:{width:"100%"}},N={name:"ContrastPage"},B=v(i(d({},N),{setup(t){const e=C(),n=M(a(e.state.lang==="en-US"?p:l));return x(()=>e.state.lang,()=>{n.value=a(e.state.lang==="en-US"?p:l)}),(y,P)=>{const c=j("md-editor-v3");return A(),E("div",w,[m("div",k,[m("div",D,[J(c,{theme:o(e).state.theme,"model-value":n.value,"preview-theme":o(e).state.previewTheme,"preview-only":"","show-code-row-number":"","code-theme":o(e).state.codeTheme},null,8,["theme","model-value","preview-theme","code-theme"])])])])}}}));export{B as default};
