import{h as r,au as d,q as m,v as s,K as l,av as h,D as p,aw as c,S as u,ax as v,c as y,a as w,b as a,o as g}from"#entry";import{_ as f}from"./C4FVnCsf.js";import{_ as k}from"./CxwbY3eM.js";import{u as x}from"./zBP5nJiZ.js";import"./DcQIYjet.js";import"./CaH81vPM.js";import"./CV2laOic.js";const o=`## 🐶 Heading
...
!!!
`,I={class:"container"},b={class:"doc"},S={name:"DemoPage"},D=r({...S,setup(_){const n=d(),e="syntax-preview",t=m(n.lang==="en-US"?o:i);return s(()=>n.lang,()=>{t.value=n.lang==="en-US"?o:i}),x({title:n.lang==="en-US"?`Syntax - ${u}`:`语法 - ${v}`,meta:[{name:"keywords",content:n.lang==="en-US"?l:h},{name:"description",content:n.lang==="en-US"?p:c}]}),(A,$)=>(g(),y("div",I,[w("div",b,[a(k,{editorId:e,modelValue:t.value},null,8,["modelValue"]),a(f,{editorId:e})])]))}});export{D as default};
