import{h as m,as as a,q as l,v as c,K as p,at as u,D as f,au as h,S as g,av as v,c as x,a as b,b as o,o as y}from"./BJZK7qXu.js";import{p as r}from"./B6f8qsXr.js";import{_ as E}from"./CRsg2bHR.js";import{_ as k}from"./C4knvdoH.js";import{r as i}from"./fSL3XPsi.js";import{u as w}from"./CdS2HtAK.js";import"./OIw_O1DN.js";import"./ZwX8YSQ6.js";import"./kMVk-VJi.js";const s=`## 😁 Basic Usage
...
`,M={class:"container"},C={class:"doc"},j={name:"DemoPage"},U=m({...j,setup(I){const n=a(),e="demo-preview",t=l(i(n.lang==="en-US"?s:d,{EDITOR_VERSION:r.dependencies["md-editor-v3"].replace("^","")}));return c(()=>n.lang,()=>{t.value=i(n.lang==="en-US"?s:d,{EDITOR_VERSION:r.dependencies["md-editor-v3"].replace("^","")})}),w({title:n.lang==="en-US"?`Example - ${g}`:`示例 - ${v}`,meta:[{name:"keywords",content:n.lang==="en-US"?p:u},{name:"description",content:n.lang==="en-US"?f:h}]}),(S,D)=>(y(),x("div",M,[b("div",C,[o(k,{editorId:e,modelValue:t.value},null,8,["modelValue"]),o(E,{editorId:e})])]))}});export{U as default};
