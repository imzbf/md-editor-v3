import{h as n,as as o,q as d,v as r,K as m,at as a,D as c,au as l,S as h,av as p,c as u,a as g,b,o as v}from"./BN79MvlG.js";import{_}from"./CmWLugaP.js";import{u as f}from"./Biq7W9TY.js";import"./BZohNvxz.js";import"./CvRSWFCp.js";const i=`## About md-editor-v3
...
`,E={class:"container"},S={class:"doc"},N={name:"AboutPage"},A=n({...N,setup(z){const t=o(),e=d(t.lang==="en-US"?i:s);return r(()=>t.lang,()=>{e.value=t.lang==="en-US"?i:s}),f({title:t.lang==="en-US"?`About - ${h}`:`关于 - ${p}`,meta:[{name:"keywords",content:t.lang==="en-US"?m:a},{name:"description",content:t.lang==="en-US"?c:l}]}),(k,C)=>(v(),u("div",E,[g("div",S,[b(_,{editorId:"md-about",modelValue:e.value},null,8,["modelValue"])])]))}});export{A as default};
