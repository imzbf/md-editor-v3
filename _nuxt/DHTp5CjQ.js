import{e as d,u as a,r as l,f as c,S as p,g as u,K as f,h,D as g,i as v,c as x,a as b,b as o,o as k}from"./BBEVvVbW.js";import{p as r}from"./BgNIB4CM.js";import{_ as y}from"./i5dWjSqW.js";import{_ as E}from"./CJgkfkH3.js";import{r as i}from"./fSL3XPsi.js";import{u as w}from"./DODm5Thz.js";import"./DDDCI9r_.js";import"./Df9nTr6V.js";import"./tHdZtrpI.js";const s=`## 😁 Basic Usage
...
`,M={class:"container"},C={class:"doc"},j={name:"DemoPage"},U=d({...j,setup(I){const n=a(),e="demo-preview",t=l(i(n.lang==="en-US"?s:m,{EDITOR_VERSION:r.dependencies["md-editor-v3"].replace("^","")}));return c(()=>n.lang,()=>{t.value=i(n.lang==="en-US"?s:m,{EDITOR_VERSION:r.dependencies["md-editor-v3"].replace("^","")})}),w({title:n.lang==="en-US"?`Example - ${p}`:`示例 - ${u}`,meta:[{name:"keywords",content:n.lang==="en-US"?f:h},{name:"description",content:n.lang==="en-US"?g:v}]}),(S,D)=>(k(),x("div",M,[b("div",C,[o(E,{editorId:e,modelValue:t.value},null,8,["modelValue"]),o(y,{editorId:e})])]))}});export{U as default};
