import{h as n,aw as o,q as d,v as r,K as m,ax as a,D as c,ay as l,S as h,az as p,c as u,a as g,b,o as _}from"#entry";import{_ as f}from"./BBtYvpo3.js";import{u as v}from"./C1K6BqhZ.js";import"./Du21dRCw.js";import"./CaH81vPM.js";const i=`## About md-editor-v3
...
`,E={class:"container"},S={class:"doc"},N={name:"AboutPage"},A=n({...N,setup(z){const t=o(),e=d(t.lang==="en-US"?i:s);return r(()=>t.lang,()=>{e.value=t.lang==="en-US"?i:s}),v({title:t.lang==="en-US"?`About - ${h}`:`关于 - ${p}`,meta:[{name:"keywords",content:t.lang==="en-US"?m:a},{name:"description",content:t.lang==="en-US"?c:l}]}),(k,C)=>(_(),u("div",E,[g("div",S,[b(f,{editorId:"md-about",modelValue:e.value},null,8,["modelValue"])])]))}});export{A as default};
