import{h as i,as as s,q as a,v as m,K as p,at as l,D as c,au as u,S as h,av as f,c as g,a as E,b as o,o as M}from"./Btx0VEc9.js";import{_ as v}from"./DcjfWH7P.js";import{_ as x}from"./Cgh9bx6S.js";import{u as C}from"./BB1RSsfP.js";import"./DJvo8HzR.js";import"./B0XqMNKj.js";import"./BgszkiSa.js";const r=`This is the content that is incompatible only.
...
- 目录导航
  ...
  **全局注册**
  ...
  <\/script>
  \`\`\`
`,b={class:"container"},I={class:"doc"},_={name:"ContrastPage"},V=i({..._,setup(w){const n=s(),e="doc-contrast",t=a(n.lang==="en-US"?r:d);return m(()=>n.lang,()=>{t.value=n.lang==="en-US"?r:d}),C({title:n.lang==="en-US"?`Version Contrast - ${h}`:`版本对比 - ${f}`,meta:[{name:"keywords",content:n.lang==="en-US"?p:l},{name:"description",content:n.lang==="en-US"?c:u}]}),(S,y)=>(M(),g("div",b,[E("div",I,[o(v,{editorId:e,modelValue:t.value},null,8,["modelValue"]),o(x,{editorId:e})])]))}});export{V as default};
