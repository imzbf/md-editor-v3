import{e as a,u as l,r as d,f as m,S as p,g as c,K as u,h as g,D as f,i as h,c as v,a as b,b as o,o as y}from"./C-C-tabz.js";import{r}from"./fSL3XPsi.js";import{_ as x}from"./Cz6NyCPb.js";import{_ as w}from"./ojhrL8tX.js";import{u as T}from"./BfmoOS7r.js";import"./BF4mhtSi.js";import"./CGppjYfp.js";import"./C-F2HosB.js";const i=`> Use it online: [Go](https://codesandbox.io/s/epic-bird-2znqo).
...
`,E={class:"container"},k={class:"doc"},M={name:"DocPage"},H=a({...M,setup(C){const n=l(),e="doc-preview",t=d(r(n.lang==="en-US"?i:s,{}));return m(()=>n.lang,()=>{t.value=r(n.lang==="en-US"?i:s,{})}),T({title:n.lang==="en-US"?`API - ${p}`:`API - ${c}`,meta:[{name:"keywords",content:n.lang==="en-US"?u:g},{name:"description",content:n.lang==="en-US"?f:h}]}),(S,j)=>(y(),v("div",E,[b("div",k,[o(x,{editorId:e,modelValue:t.value},null,8,["modelValue"]),o(w,{editorId:e})])]))}});export{H as default};
