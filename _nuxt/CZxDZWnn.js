import{h as a,aw as l,p as d,q as m,K as p,ax as c,D as u,ay as g,S as f,az as h,c as v,a as b,b as o,o as y}from"#entry";import{_ as x}from"./D2Xn8Hnj.js";import{_ as w}from"./CX9DeQA-.js";import{r}from"./n3mbQldj.js";import{u as T}from"./C1K6BqhZ.js";import"./Bc4MD_Gn.js";import"./BDxgAFMV.js";import"./BQaxBUgI.js";const i=`> Use it online: [Go](https://codesandbox.io/s/epic-bird-2znqo).
...
- **default**: \`false\`
  ...
  Using the following \`<img>\` tag directly in Markdown requires enabling \`html: true\` through [markdownItConfig](https://imzbf.github.io/md-editor-v3/en-US/api#%F0%9F%8D%A4%20markdownItConfig).
...
`,k={class:"container"},M={class:"doc"},E={name:"DocPage"},D=a({...E,setup(C){const n=l(),e="doc-preview",t=d(r(n.lang==="en-US"?i:s,{}));return m(()=>n.lang,()=>{t.value=r(n.lang==="en-US"?i:s,{})}),T({title:n.lang==="en-US"?`API - ${f}`:`API - ${h}`,meta:[{name:"keywords",content:n.lang==="en-US"?p:c},{name:"description",content:n.lang==="en-US"?u:g}]}),(I,j)=>(y(),v("div",k,[b("div",M,[o(w,{editorId:e,modelValue:t.value},null,8,["modelValue"]),o(x,{editorId:e})])]))}});export{D as default};
