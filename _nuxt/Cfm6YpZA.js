import{h as a,as as l,q as d,v as m,K as p,at as c,D as u,au as g,S as f,av as v,c as h,a as b,b as o,o as y}from"./CvllZicE.js";import{r}from"./fSL3XPsi.js";import{_ as x}from"./BNjcjmAu.js";import{_ as w}from"./COnSnRVD.js";import{u as T}from"./CfTIekVR.js";import"./Cktl9nWE.js";import"./iLgOCPIG.js";import"./Dp_DE2ma.js";const i=`> Use it online: [Go](https://codesandbox.io/s/epic-bird-2znqo).
...
`,E={class:"container"},k={class:"doc"},M={name:"DocPage"},H=a({...M,setup(C){const n=l(),e="doc-preview",t=d(r(n.lang==="en-US"?i:s,{}));return m(()=>n.lang,()=>{t.value=r(n.lang==="en-US"?i:s,{})}),T({title:n.lang==="en-US"?`API - ${f}`:`API - ${v}`,meta:[{name:"keywords",content:n.lang==="en-US"?p:c},{name:"description",content:n.lang==="en-US"?u:g}]}),(S,j)=>(y(),h("div",E,[b("div",k,[o(x,{editorId:e,modelValue:t.value},null,8,["modelValue"]),o(w,{editorId:e})])]))}});export{H as default};
