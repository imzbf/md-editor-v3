import{h as r,as as d,q as m,v as s,K as l,at as h,D as c,au as p,S as u,av as v,c as w,a as f,b as a,o as g}from"./B-OubXq9.js";import{_ as y}from"./U1DhYMmy.js";import{_ as k}from"./wxhbnZOT.js";import{u as I}from"./Cvbl71lS.js";import"./5SwqCdXY.js";import"./C25qTEBd.js";import"./Bamva9qN.js";const o=`## 🐶 Heading
...
!!!
\`\`\`
`,x={class:"container"},b={class:"doc"},_={name:"DemoPage"},z=r({..._,setup(S){const n=d(),e="syntax-preview",t=m(n.lang==="en-US"?o:i);return s(()=>n.lang,()=>{t.value=n.lang==="en-US"?o:i}),I({title:n.lang==="en-US"?`Syntax - ${u}`:`语法 - ${v}`,meta:[{name:"keywords",content:n.lang==="en-US"?l:h},{name:"description",content:n.lang==="en-US"?c:p}]}),($,A)=>(g(),w("div",x,[f("div",b,[a(k,{editorId:e,modelValue:t.value},null,8,["modelValue"]),a(y,{editorId:e})])]))}});export{z as default};
